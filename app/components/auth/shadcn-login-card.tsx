...
export default function ShadcnLoginCard() {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Error sending the magic link. Please try again.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  const handleMicrosoftLogin = async () => {
    try {
      ...
      toast({
        title: "Authentication Error",
        description: "Error signing in with Microsoft. Please try again.",
        variant: "destructive",
      });
    }
  };
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader>
        <CardTitle className="text-2xl text-center">Log in to TechNews</CardTitle>
        <CardDescription className="text-center">
          Access the latest tech news and updates
        </CardDescription>
      </CardHeader>
      <CardContent>
